...
import 'globals.dart' as globals; //GLOBALS
                  ...
                  children: [
                    SleekCircularSlider(
                      appearance: CircularSliderAppearance(
                          animationEnabled: true,
                          customWidths:
                              CustomSliderWidths(progressBarWidth: 17),
                    ...
                    CupertinoButton(
                      onPressed: () {
                        if (_formKey.currentState.validate()) {
                            setState(() {
                              globals.runningPage = 1;
                            });
                          }
                      },
                      child: Text('Choose Your Songs'),
                    ),
                    // Slider(
                    //       min: 0,
                    //       max: 100,
                    ...
                    /*Container(
                      ...
                      child: CupertinoButton(
                        ...
                        child: Text('Choose From Youtube!'),
                      ),
                    ),*/
                  ],
                ),
