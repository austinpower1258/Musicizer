/*
UPDATED: 7/29/20
Routing page handles the routing between the 3 pages:
1. Home
2. Time-Level
3. Profile
...
import '../musicize/music_routing.dart';
import 'dart:async';
import 'home_page.dart';
import 'profile_page.dart';

class Routing extends StatefulWidget {
  Routing({Key key, this.auth, this.userId, this.logoutCallback})
      : super(key: key);
  ...
  @override
  State<StatefulWidget> createState() => new _RoutingState();
}
