...
class _SearchCardsState extends State<SearchCards> {
  ...
  void deleteFromPlaylist(int index) {
    ...
    globals.totalMinutes -= globals.streamPlaylist[index].video.duration.inMinutes;
    if ((globals.streamPlaylist[index].video.duration.inSeconds % 60) >= 30) {
      globals.totalMinutes--;
    }
    globals.streamPlaylist.remove(
         globals.streamPlaylist[index]);
                          ...
                          children: <Widget>[
                            ...
                            Container(
                              ...
                              child: Row(
                                ...
                                children: <Widget>[
                                  Text(
                                    globals.streamPlaylist.length.toString() +
                                        ' Songs | ' +
                  ...
                  child: Container(
                      ...
                      child: new Expanded(
                          child: ListView(
                            ...
                            if (globals.streamPlaylist.length == 0) ...[
                              Container(
                                height:
                                    MediaQuery.of(context).size.height - 285,
                                child: Column(
                                  mainAxisAlignment:
                            ...
                            ConditionalBuilder(
                              condition: globals.streamPlaylist != [],
...
class _VideoLayoutState extends State<VideoLayout> {
  ...
  Widget _myListView(BuildContext context) {
    return ListView.builder(
      shrinkWrap: true,
      physics: ClampingScrollPhysics(),
      itemCount: globals.streamPlaylist.length,
        ...
        return GFListTile(
            ...
            avatar: GFAvatar(
                ...
                backgroundImage: NetworkImage(
                    globals.streamPlaylist[index].video.thumbnails.highResUrl,
                    scale: 1.5)),
            title: AutoSizeText(globals.streamPlaylist[index].video.title,
                maxLines: 2,
                style: TextStyle(
                    color: Colors.black, fontWeight: FontWeight.w600)),
            subTitle: AutoSizeText(globals.streamPlaylist[index].video.author,
                maxLines: 1,
                style: TextStyle(
                    color: Colors.black,
            ...
            description: AutoSizeText(
                globals.streamPlaylist[index].video.duration.toString().split('.')[0],
                maxLines: 1,
                style: TextStyle(
                    color: Colors.black,
