    ...
    return IntroductionScreen(
      ...
      pages: [
        ...
        PageViewModel(
          ...
          body:
              "We change the tempo of the music in help you to keep a consistent pace.",
          image: _buildImage('onboarding-1'),
           decoration: PageDecoration(titleTextStyle: TextStyle(color: HexColor('#5660E8')),),
        ),
        PageViewModel(
          title: "Stream Music",
          body:
              "Stream all of your favorite music, ad-free. Just search for a song.",
          image: _buildImage('onboarding-2'),
           decoration: PageDecoration(titleTextStyle: TextStyle(color: HexColor('#5660E8')),),
        ),
        PageViewModel(
          title: "Earn Musicpoints",
          body: "Track your progress and compete against others in the world.",
